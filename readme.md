...
![complete](https://img.shields.io/static/v1?label=&message=complete&color=green) = ready for User Acceptance Testing (UAT)<br>
![deployed](https://img.shields.io/static/v1?label=&message=deployed&color=success) = UAT Passed and merged to Master<br>
...
![definition](https://img.shields.io/static/v1?label=&message=needs_definition&color=orange) = blocked task that needs discussion with mentor<br>
![important](https://img.shields.io/static/v1?label=&message=important&color=red) = something that needs to be addressed immediately<br>
![uat-passed](https://img.shields.io/static/v1?label=UAT&message=passed&color=success)<br>

...
| [MS COCO](http://cocodataset.org/) | [Lin et al. 2014] Lin, T. Y., Maire, M., Belongie, S., Hays, J., Perona, P., Ramanan, D., ... & Zitnick, C. L. (2014, September). [Microsoft coco: Common objects in context.](https://arxiv.org/abs/1405.0312) In *European conference on computer vision* (pp. 740-755). Springer, Cham. |
